 ...
 */
class AuraUnityActivity : UnityPlayerActivity() {
    ...
    override fun onResume() {
        ...
        reintentosMs.forEach { delay ->
            handler.postDelayed({ UnityAuraBridge.send(aura) }, delay)
        }
    }
        ...
        Thread {
            try {
                val valores = ContentValues().apply {
                    put(MediaStore.Images.Media.DISPLAY_NAME, "aura_${System.currentTimeMillis()}.jpg")
